  ...
  factory RitualData.fromJson(Map<String, dynamic> json) {
    return RitualData(
      ...
      gradient: LinearGradient(
        colors: (json['gradientColors'] as List).map((c) => Color(c as int)).toList(),
        begin: Alignment.topLeft,
        end: Alignment.bottomRight,
      ),
      defaultSettings: Map<String, dynamic>.from(json['defaultSettings'] as Map),
    );
  }
...
class RitualDataProvider {
  static const List<RitualData> availableRituals = [
    RitualData(
      ...
      description: 'Let your mind drift into your dream life as you fall asleep. This ritual helps you visualize your goals and primes your subconscious for success overnight.',
    ...
    RitualData(
      ...
      description: 'Start your day with clarity and energy. This ritual focuses your mind on your vision, setting a positive and productive tone for the day.',
    ...
    RitualData(
      ...
      description: 'Take a mindful pause to reset and reconnect. This ritual brings you back to calm, helping you regain clarity and composure.',
    ...
    RitualData(
      ...
      description: 'Immerse yourself in the life you\'re building. This ritual strengthens your vision and motivation, making your dreams feel real and attainable.',
  ...
  static List<String> get allDurations {
    ...
    for (final ritual in availableRituals) {
      final ritualDurations = ritual.defaultSettings['duration'] as List<String>?;
  ...
  static List<RitualData> filterRituals({
    ...
    return availableRituals.where((ritual) {
      if (ritualType != null && !ritual.defaultSettings['ritualType']?.contains(ritualType) == true) {
        return false;
      }
      if (tone != null && !ritual.defaultSettings['tone']?.contains(tone) == true) {
        return false;
      }
      if (voice != null && !ritual.defaultSettings['voice']?.contains(voice) == true) {
        return false;
      }
      if (duration != null && !ritual.defaultSettings['duration']?.contains(duration) == true) {
        return false;
      }
      return true;
    }).toList();
