...
class AppStyles {
  ...
  static const EdgeInsets paddingHorizontalLarge = EdgeInsets.symmetric(horizontal: 32.0);
  ...
  static const BorderRadius radiusExtraLarge = BorderRadius.all(Radius.circular(30));
                ...
                children: items.map((e) => ListTile(
                  title: Text(
                    ...
                    style: AppStyles.buttonTextSmall.copyWith(
                      color: value == e ? AppStyles.white : AppStyles.white.withOpacity(0.7),
